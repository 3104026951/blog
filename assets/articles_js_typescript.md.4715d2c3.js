import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.a0e7c6b8.js";const h=JSON.parse('{"title":"模板字符串","description":"","frontmatter":{},"headers":[],"relativePath":"articles/js/typescript.md","filePath":"articles/js/typescript.md"}'),l={name:"articles/js/typescript.md"},p=a(`<h2 id="泛型" tabindex="-1">泛型 <a class="header-anchor" href="#泛型" aria-label="Permalink to &quot;泛型&quot;">​</a></h2><h3 id="类型别名中的泛型" tabindex="-1">类型别名中的泛型 <a class="header-anchor" href="#类型别名中的泛型" aria-label="Permalink to &quot;类型别名中的泛型&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 等价于一个接受参数的函数</span></span>
...
<span class="line"><span style="color:#24292e;">type PropTypeUnion2 = Foo[A]; // string | number | boolean</span></span></code></pre></div><h2 id="多泛型关联" tabindex="-1">多泛型关联 <a class="header-anchor" href="#多泛型关联" aria-label="Permalink to &quot;多泛型关联&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">type Conditional&lt;Type, Condition, TruthyResult, FalsyResult&gt; =</span></span>
...
<span class="line"><span style="color:#24292e;">type Result2 = Conditional&lt;&#39;linbudu&#39;, boolean, &#39;passed!&#39;, &#39;rejected!&#39;&gt;;</span></span></code></pre></div><h2 id="对象类型中的泛型" tabindex="-1">对象类型中的泛型 <a class="header-anchor" href="#对象类型中的泛型" aria-label="Permalink to &quot;对象类型中的泛型&quot;">​</a></h2><p>最常见的一个例子应该还是响应类型结构的泛型处理，预留出了实际响应数据的泛型坑位，然后在你的请求函数中就可以传入特定的响应类型了</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">interface IRes&lt;TData = unknown&gt; {</span></span>
...
<span class="line"><span style="color:#24292e;">function fetchUserProfileList(): Promise&lt;IRes&lt;IPaginationRes&lt;IUserProfileRes&gt;&gt;&gt; {}</span></span></code></pre></div><h2 id="函数中的泛型" tabindex="-1">函数中的泛型 <a class="header-anchor" href="#函数中的泛型" aria-label="Permalink to &quot;函数中的泛型&quot;">​</a></h2><p>在基于参数类型进行填充泛型时，其类型信息会被推断到尽可能精确的程度</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// TS内置类型</span></span>
...
<span class="line"><span style="color:#24292e;">  : T;</span></span></code></pre></div><h2 id="内置工具类型拓展" tabindex="-1">内置工具类型拓展 <a class="header-anchor" href="#内置工具类型拓展" aria-label="Permalink to &quot;内置工具类型拓展&quot;">​</a></h2><h3 id="内置工具类型" tabindex="-1">内置工具类型 <a class="header-anchor" href="#内置工具类型" aria-label="Permalink to &quot;内置工具类型&quot;">​</a></h3><p>在ts中有很多内置的工具类型，比如：</p><h4 id="_1-属性修饰工具类型" tabindex="-1">1.属性修饰工具类型 <a class="header-anchor" href="#_1-属性修饰工具类型" aria-label="Permalink to &quot;1.属性修饰工具类型&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">type Partial&lt;T&gt; = {</span></span>
<span class="line"><span style="color:#e1e4e8;">    [P in keyof T]?: T[P];</span></span>
<span class="line"><span style="color:#e1e4e8;">};</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#24292e;">type BExcludeA = Exclude&lt;SetB, SetA&gt;; // 0 | 4</span></span></code></pre></div><h2 id="属性修饰进阶" tabindex="-1">属性修饰进阶 <a class="header-anchor" href="#属性修饰进阶" aria-label="Permalink to &quot;属性修饰进阶&quot;">​</a></h2><h4 id="深层的属性修饰" tabindex="-1">深层的属性修饰 <a class="header-anchor" href="#深层的属性修饰" aria-label="Permalink to &quot;深层的属性修饰&quot;">​</a></h4><p>就是类似于深拷贝的递归调用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">export type DeepPartial&lt;T extends object&gt; = {</span></span>
