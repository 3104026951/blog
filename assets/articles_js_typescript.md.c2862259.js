import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.5784490e.js";const h=JSON.parse('{"title":"# 泛型","description":"","frontmatter":{},"headers":[],"relativePath":"articles/js/typescript.md","filePath":"articles/js/typescript.md"}'),l={name:"articles/js/typescript.md"},p=a(`<h1 id="泛型" tabindex="-1"># 泛型 <a class="header-anchor" href="#泛型" aria-label="Permalink to &quot;# 泛型&quot;">​</a></h1><h3 id="类型别名中的泛型" tabindex="-1">类型别名中的泛型 <a class="header-anchor" href="#类型别名中的泛型" aria-label="Permalink to &quot;类型别名中的泛型&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 等价于一个接受参数的函数</span></span>
